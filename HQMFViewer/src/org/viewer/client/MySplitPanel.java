...
//            setAssociatedWidgetSize(size);
  ...
  private static final int DEFAULT_SPLITTER_SIZE = 15;
  ...
  /**
   * Construct a new {@link MySplitPanel} with the default splitter size of
   * 8px.
   */
  public MySplitPanel() {
  ...
  /**
   * Construct a new {@link MySplitPanel} with the specified splitter size
   * in pixels.
   *
   * @param splitterSize the size of the splitter in pixels
   */
  public MySplitPanel(int splitterSize) {
    super(Unit.PX);
