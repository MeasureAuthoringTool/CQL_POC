...
(function() {
    ...
    this.updateCompletions = function(keepPopupPosition) {
        ...
        this.gatherCompletions(this.editor, function(err, results) {
            ...
            if(keyString == "t"){
            	...
            	//alert("keyString:"+this.editor.keyString);
            	matches = [];
            	var functionKeywords = ["Age At","Avg", "Count", "Datetimediff", "Fifth","First", "Fourth", "Max","Median","Min","Most Recent","Satisfies All","Satisfies Any","Second","Sum","Third","AgeInYearsAt"];
    ...
    this.showDocTooltip = function(item) {
        ...
        tooltipNode.style.wordWrap = "normal"; // Need to investigate how to wrap on words and for max width to be enforced at the same time .... 
